...
/** One catalog for rendering, validation and handoff; options never require AI interpretation. */
export const STORY_PREFERENCE_CATALOG: readonly PreferenceCategory[] = [
  {
    id: "style",
    label: "画面风格",
...
export interface StoredStoryBrief {
  preferences: StoryPreference[];
  ideas: string;
}
export function preferenceLabel(preference: StoryPreference) {
